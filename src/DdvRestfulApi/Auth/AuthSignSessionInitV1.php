 ...
 *
 */
class AuthSignSessionInitV1 extends AuthSign implements AuthSignInterface
{
    ...
    private function createAuthData()
    {
        ...
        return array(
            ...
            'serverTime' => time(),
            'sessionData' => array(
                'sessionPrefix' => $this->signInfo->getHeadersPrefix(),
                'sessionId' => $sessionId,
    ...
    private function checkAuth()
    {
        ...
        //授权字符串
        $authString = "{$authVersion}/{$requestId}/{$sessionId}/{$sessionCard}/{$signTimeString}/{$expiredTimeOffset}";
        //生成加密key
